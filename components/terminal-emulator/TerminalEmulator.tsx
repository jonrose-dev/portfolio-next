...
export const TerminalEmulator = () => {
  ...
  return (
    <div className="animate-[appear_ease-out_0.8s] w-[90vw] max-w-4xl bg-black px-3 py-2 h-fit min-h-[500px] rounded-md shadow-emulator" aria-label="Interactive terminal demonstration">
      <div className="flex gap-x-1 h-[10px]" aria-hidden="true">
      ...
      <div className="text-white pt-5" role="log" aria-live="polite" aria-atomic="false">
